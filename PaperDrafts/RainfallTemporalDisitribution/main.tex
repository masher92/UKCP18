...
%    \includegraphics[width=\linewidth]{Figs/SpatialPlots/O_c5_2.png}
% \end{subfigure}
%   \begin{subfigure}[b]{0.05\textwidth}
%                         \textbf{(b)}
%   \end{subfigure}
% \begin{subfigure}{0.38\linewidth}
%    \includegraphics[width=\linewidth]{Figs/SpatialPlots/WB_O_c5.png}
% \end{subfigure}
% \begin{subfigure}{0.04\linewidth}
%    \includegraphics[width=\linewidth]{Figs/SpatialPlots/legend.png}
% \end{subfigure}
...
\begin{figure*}[!t]
  ...
  \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=0.49\linewidth]{Figs/FloodedAreaBarCharts/LD_Notwater.PNG}%
        \includegraphics[width=0.49\linewidth]{Figs/FloodedAreaBarCharts/WB_Notwater.PNG}
    \end{subfigure}
    % \vskip\baselineskip
      \begin{subfigure}[b]{\textwidth}
                        \textbf{(b)}
  \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=0.49\linewidth]{Figs/FloodedAreaBarCharts/LD_Urban.PNG}%
        \includegraphics[width=0.49\linewidth]{Figs/FloodedAreaBarCharts/WB_Urban.PNG}
        \raggedleft
        \includegraphics[width=.94\linewidth]{Figs/FloodedAreaBarCharts/legend.PNG}
    \end{subfigure}
...
\todo[inline]{Mark's comments suggested it was confusing that I was quoting percentages in this text that do not relate to those in the plot (i.e. \% difference between two most different profiles. Perhaps I should just leave this out of being mentioned for now - it is mentioned later in Table 5. SO if I wanted to quote this as a headline figure in any case, I still could}
...
\renewcommand{\arraystretch}{1.5} % Default value: 1
\begin{table*}[]
\caption{Differences in flooded area (for $>$0.1m depth) between two most extreme profiles (O5 and O8; I1 and I9), for areas which are not classed as permanent water. For the depth and velocity categories, the percentage of the total difference in area between the two rainfall profiles which is found in each of the categories is shown in brackets}\label{table:depth_changes}
...
\begin{figure}[tb]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\linewidth, valign=t]{Figs/Histograms/IP_Histograms_withoutwater.PNG}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{\textwidth}
    \textbf{                       (b)}
  \end{subfigure}
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\linewidth, valign=t]{Figs/Histograms/OP_Histograms_withoutwater.PNG}
  \end{subfigure}
...
\begin{figure}[tb]
  ...
  \end{subfigure}
  \begin{subfigure}[t]{0.45\textwidth}
  \includegraphics[width=\linewidth, valign=t]{Figs/HazardPlots/IP_HazardCats_withoutwater.PNG}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{\textwidth}
    \textbf{                  (b)}
  \end{subfigure}
  \begin{subfigure}[t]{0.45\textwidth}
\includegraphics[width=\linewidth, valign=t]{Figs/HazardPlots/OP_HazardCats_withoutwater.PNG}
  \end{subfigure}
