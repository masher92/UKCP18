...
general_filename = f'/nfs/a319/gy17m2a/PhD/datadir/UKCP18_every30mins/2.2km_bng_masked/2002_2020/{em}/bng_{em}a.pr*'
cubes = load_files_to_cubelist(general_filename)

print("Joining cubes")
em_cube = cubes.concatenate_cube()
print(em_cube.coord('time'))
print(em_cube.shape)
...
output_path = f'/nfs/a319/gy17m2a/PhD/ProcessedData/PDF_Plotting/UKCP18_30mins/{em}_jja_gaugelocs_2km.npy'
