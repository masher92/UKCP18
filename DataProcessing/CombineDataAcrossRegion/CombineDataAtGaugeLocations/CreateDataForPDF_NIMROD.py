...
general_filename = f'/nfs/a161/gy17m2a/PhD/datadir/NIMROD/30mins/NIMROD_regridded_2.2km/unfiltered/AreaWeighted/{yr}/*'
...
try:
    ...
    try:
        em_cube = remove_problematic_cubes(cubes)
...
output_path = f'/nfs/a319/gy17m2a/PhD/ProcessedData/TimeSeries/NIMROD/30mins/NIMROD_regridded_2.2km/jja_gaugelocs_2km.npy'
