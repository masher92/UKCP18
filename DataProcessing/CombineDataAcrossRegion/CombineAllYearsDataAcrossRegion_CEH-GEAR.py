...
for year in years:
    ...
    if not os.path.isdir(ddir):
        os.makedirs(ddir)
    if not os.path.isfile(ddir + f'{year}_compressed_GB_jja.npy'):
        filenames =[]
        ...
        np.save(ddir + f'{year}_compressed_UK_jja.npy', compressed)         
        ...
        np.save(ddir + f'{year}_compressed_GB_jja.npy', compressed) 
    else:
        print("exists")