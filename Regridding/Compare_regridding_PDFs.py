def find_closest_coordinates(cube, sample_point):
...
def check_location_of_closestpoint (cube, closest_point_idx, sample_point, input_crs, target_crs):
...
sample_point = [('grid_latitude', 53.79282), ('grid_longitude', -1.37818)]
