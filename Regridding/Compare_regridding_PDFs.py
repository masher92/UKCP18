...
# lats = concat_cube.coord('projection_x_coordinate').points
# lats_2d, lons_2d = np.meshgrid(lats, lons) 
# lons = concat_cube.coord('projection_y_coordinate').points
...
def create_trimmed_cube(gdf, string, target_crs):    
  ...
  #lats_rfmt = cube_rfmt.coord('projection_x_coordinate').points
  #lons_rfmt = cube_rfmt.coord('projection_y_coordinate').points
...
leeds_at_centre_gdf.plot(categorical=True, alpha=1, edgecolor='black', color='none', linewidth=6)
leeds_gdf.plot(categorical=True, alpha=1, edgecolor='black', color='none', linewidth=6)
