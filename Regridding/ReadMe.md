...
<p align="center"> 1km grid on which observations are originally supplied (left); and 2.2km grid of the UKCP18 model data, onto which the observations are regridded (right) <p align="center">
