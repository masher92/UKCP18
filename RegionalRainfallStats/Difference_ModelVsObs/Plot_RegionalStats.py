...
for region in ['leeds', 'leeds-at-centre', 'Northern', 'UK']:
    for overlapping in ['', '_overlapping']:
        for stat in stats:
            ...
            obs_cube= iris.load('/nfs/a319/gy17m2a/Outputs/RegionalRainfallStats/NetCDFs/RegriddedObservations/NearestNeighbour/{}{}.nc'.format(stat, overlapping))[0]
            ...
            if region == 'Northern':
                 ...
                 diff_cube = trim_to_bbox_of_region_regriddedobs(diff_cube, leeds_gdf)                 
