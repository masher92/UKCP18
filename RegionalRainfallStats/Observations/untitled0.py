...
general_filename = 'Outputs/CEH-GEAR_regridded_2.2km/LinearRegridding/rg_*'
...
lons_wgs84_2d, lats_wgs84_2d = iris.analysis.cartography.unrotate_pole(lons_rp_2d, lats_rp_2d, cs.grid_north_pole_longitude, cs.grid_north_pole_latitude)

# Convert to 1D
lons_wgs84_1d = lons_wgs84_2d.reshape(-1)
lats_wgs84_1d = lats_wgs84_2d.reshape(-1)

coord_iris = iris.coords.AuxCoord(lats_wgs84_2d, long_name = 'latitude2')
concat_cube.add_aux_coord(coord_iris, 3) 
...
lons_wgs84_2d, lats_wgs84_2d = iris.analysis.cartography.unrotate_pole(lons, lats, cs.grid_north_pole_longitude, cs.grid_north_pole_latitude)
...
iplt.pcolormesh(concat_cube[18])
############################################
...
iplt.pcolormesh(trimmed_cube[18])
