...
<p align="center"> Figure 8. Direct runoff in ml (left) and peak flow in m<sup>3</sup>/s (right) for a 1 year return period event in summer using an urbanised scenario <p align="center">
