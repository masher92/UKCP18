...
* Select 'export' above the plot of 'Observed rainfall - 05/04/22 - as rural' to export the rainfall with rural model losses remove
* Select 'export' above the plot of 'Observed rainfall - 05/04/22 - urbanised' to export the rainfall with urban model losses remove
...
The plot in Figure 6 shows the rainfall data for a 6 hour storm after losses have been removed (using both the rural and urban model) for each of the methods.
