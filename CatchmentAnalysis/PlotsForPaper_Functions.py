...
def boxplot(individual_cell_values_ls, fl_method,bl_method, variable_name, ax, title, outliers = False):
...
def plot_histogram (individual_cell_values_ls, variable_name, profiles_name, profiles_name_short, smallest_method,
    ...
    fig, axs = plt.subplots(ncols= 2, nrows=1, sharey=False,figsize = (12,2.5), gridspec_kw={'hspace':1, 'wspace': 0.2})
