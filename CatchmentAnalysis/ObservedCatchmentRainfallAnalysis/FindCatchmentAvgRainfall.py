...
times = np.load('PhD/Scripts/CatchmentAnalysis/ObservedCatchmentRainfallAnalysis/times_jja.npy')

# Get a list of all the individual grid cell JJA .npy files
jja_npy_files = glob.glob('PhD/Scripts/CatchmentAnalysis/ObservedCatchmentRainfallAnalysis/*_jja.npy')
...
lindyke_jja = np.load('PhD/Scripts/CatchmentAnalysis/ObservedCatchmentRainfallAnalysis/LinDyke_jja.npy')
np.mean(lindyke_jja)
