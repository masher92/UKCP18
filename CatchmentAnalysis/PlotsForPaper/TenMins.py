    ...
    for H in Hs:
        ...
        for M in Ms:
            ...
            if methods_key == 'Observed' and method == '6h_feh_singlepeak':
                fp = feh_directory + '6h_feh_singlepeak/Depth (01AUG2022 {} {} 00).{}.tif'.format(H, M, filename_ending)
            else:
                fp = model_directory + '{}/Depth (01AUG2022 {} {} 00).{}.tif'.format(method, H, M, filename_ending)
...
#                 n_flooded_cells_urban.append(number_flooded_cells_urban)
                ...
                if catchment_name == 'LinDyke':
                    ...
                    number_flooded_cells_nowetlands = depth_timeslice_nowetlands[depth_timeslice_nowetlands>0.1].size
                    n_flooded_cells_nowetlands.append(number_flooded_cells_nowetlands)
...
#         n_flooded_cells_dict_kippax_over10[method] = n_flooded_cells_kippax_over10    
        n_flooded_cells_dict_nowetlands[method] = n_flooded_cells_nowetlands
...
#     df_garforth_over10.to_csv("Data/FloodedAreaOverTime/{}/{}/garforth_over10_10mins.csv".format(catchment_name, methods_key), index=False)
#     df_kippax.to_csv("Data/FloodedAreaOverTime/{}/{}/kippax_10mins.csv".format(catchment_name, methods_key), index=False)
#     df_kippax_over10.to_csv("Data/FloodedAreaOverTime/{}/{}/kippax_over10_10mins.csv".format(catchment_name, methods_key), index=False)
    df_nowetlands.to_csv("Data/FloodedAreaOverTime/{}/{}/nowetlands_nopermwater_over10_10mins.csv".format(catchment_name, methods_key), index=False)
