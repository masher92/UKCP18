...
obs_ts_cube = iris.load(f'Outputs/TimeSeries_cubes/Obs_{start_year}-{end_year}.nc')[0]
print(obs_ts_cube)
...
obs_ts_cube = obs_ts_cube.extract(days_constraint)

###############################################################################
# Load in one month's worth of data in a cube for whole of country
###############################################################################                               
filename = "datadir/CEH-GEAR/pr_rcp85_land-cpm_uk_2.2km_01_1hr_19821201-19821230.nc"
